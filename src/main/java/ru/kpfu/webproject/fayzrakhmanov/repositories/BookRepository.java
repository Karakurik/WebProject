...
import ru.kpfu.webproject.fayzrakhmanov.Exceptions.IsbnAlreadyExistsException;
import ru.kpfu.webproject.fayzrakhmanov.Exceptions.UnrealPublishDateException;
...
public interface BookRepository extends CrudRepository<Book> {
    ...
    void checkIsbn(Book entity) throws IsbnAlreadyExistsException;

    boolean validateBook(Book book) throws UnrealPublishDateException;
}
